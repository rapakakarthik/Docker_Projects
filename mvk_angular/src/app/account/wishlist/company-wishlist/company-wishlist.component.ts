...
@Component({
  selector: 'app-company-wishlist',
  templateUrl: './company-wishlist.component.html',
  styleUrl: './company-wishlist.component.scss'
})
export class CompanyWishlistComponent implements OnInit {
